...
<meta property="og:title" content="<?=$current->title_geo?>" />
<meta property="og:image" content="/images/<?=$current->img?>" />
<meta property="og:url" content="realpalace.ge/current/<?=$current->id?>" />
                    ...
                    <div class="col-lg-12 col-sm-6 overflow-box pull-right">
                        <div class="about-box diffuse-shadow wow fadeInRight" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
                            ...
                            <div class="about-content">
                                ...
                                <!-- SECTION HEADING -->
                                <h3 class="section-heading text-left MTMedium"><?=$current->title_eng?></h3>

                                <!-- PARAGRAPH -->
                                <span class="text-left NusRegular"><?=$current->content_eng?></span>
                            </div>
                    ...
                    <div class="col-lg-12 col-sm-6 overflow-box pull-right">
                        <div class="about-box diffuse-shadow wow fadeInRight" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
                            ...
                            <div class="about-content">
                                ...
                                <!-- SECTION HEADING -->
                                <h3 class="section-heading text-left MTMedium"><?=$current->title_rus?></h3>

                                <!-- PARAGRAPH -->
                                <span class="text-left NusRegular"><?=$current->content_rus?></span>
                            </div>
