...
<div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation" role="navigation">
    <select id="languages" class="form-control" style="max-width: 80px; position: absolute; right: 60px; top: 20px;">
...
<section class="subscribe-section">
    ...
    <!-- HEADING -->
    <h3 class=" wow fadeInLeft" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">Call me</h3>
    ...
    <form class="subscribe-form mailchimp wow fadeInRight" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
        ...
        <button type="submit" class="btn btn-default standard-button red-button">Call me</button>
    </form>
